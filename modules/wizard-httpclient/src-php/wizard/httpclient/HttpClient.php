...
class HttpClient extends Component
{
     ...
     * @var string
     */
    private $userAgent = 'Wizard Http Client';
    ...
    public function send(HttpRequest $request): HttpResponse
    {
        ...
        $event = new Event('before', $this, null, ['request' => $request, 'connection' => $connect]);
        $this->trigger($event);
    ...
    protected function connect(HttpRequest $request, $fullUrl, URLConnection $connection, $body): HttpResponse
    {
        ...
        $this->trigger(new Event('after', $this, null, ['response' => $response]));
